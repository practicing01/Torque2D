...
#include "Banana_Modifications/Struct_Module/Struct_Module_Functions/Function_Struct_Module_Main_Destroy.cc"

#include "Banana_Modifications/Struct_Module/Struct_Module_Functions/Function_Struct_Module_Main_Link.cc"

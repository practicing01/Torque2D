...
function Module_Gui_Server_Menu::Scene_Load(%this)
{
...
%this.Scene_Current=TamlRead("./../../scenes/Module_Gui_Server_Menu.scene.taml");
...
if (!isObject(Gui_Server_Menu))
{

Dots_and_Crits.add(TamlRead("./../../gui/Gui_Server_Menu.gui.taml"));

}

Canvas.pushDialog(Gui_Server_Menu);
